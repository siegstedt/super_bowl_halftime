...
# Explore files
print('In our working directory we have:')
get_ipython().system('ls datasets')
print('\nInspect the raw file super_bowls.csv:')
get_ipython().system('head -n 5 datasets/super_bowls.csv')
print('\nInspect the raw file tv.csv:')
get_ipython().system('head -n 5 datasets/tv.csv')
print('\nInspect the raw file halftime_musicians.csv:')
get_ipython().system('head -n 5 datasets/halftime_musicians.csv')
